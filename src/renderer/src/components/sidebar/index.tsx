...
import { useRuntimeEnvironmentReadyRefresh } from '@/components/sidebar/use-runtime-environment-ready-refresh'
...
function Sidebar({
  ...
  // Host-scope the runtime-environment online-set refresh (see hook for the why).
